...
#Vamos a agregar titulo para la pagina web
st.title("Configuracion inicial")
#Agregamos un textobox en la pagina web
st.write("Primera prueba de uso de streamlit y ambiente de MA2026")
#El Slider de streamlit me permite ingresar por un slider si parametro inversion
gasto=st.slider("Seleccine nivel de gasto en publicicdad", 10,200,50)
#Variables de nuestros modelos
...
#En Streamlit tenemos un boton que dice predecir 
